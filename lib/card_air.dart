...
class _AdditionalCardState extends State<AdditionalCard> {
  ...
  double getWaterLevelPercentage() {
    double level = (maxDistance - currentDistance) / (maxDistance - minDistance);
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      color: Colors.white, // Mengubah warna latar belakang kartu menjadi putih
      child: Padding(
            ...
            Stack(
              children: [
                ...
                AnimatedContainer(
                  ...
                  height: 24,
                  width: MediaQuery.of(context).size.width * 0.75 * waterLevel,
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(12),
